...
Public Class Anasayfa
    ...
    Private Sub Data_Oku_Buton_Click(sender As Object, e As EventArgs) Handles Data_Oku_Buton.Click
        ...
        Okunan_Eeprom_Data_Text.Text = Marshal.PtrToStringAnsi(Read_Protected_Data(Giden_Session_Text.Text, Data_Oku_Pin_Text.Text, CInt(Adres_Text.Text), Data_Key_Text.Text))
    ...
    Private Sub Data_Yaz_Buton_Click(sender As Object, e As EventArgs) Handles Data_Yaz_Buton.Click
        Dim Gelen As String = Marshal.PtrToStringAnsi(Write_Protected_Data(Veri_Yazma_SessionID_Text.Text, Veri_Yazma_Pin_Text.Text, CInt(Veri_Yazma_Adres_Text.Text), Veri_Yazma_Data_Key_Text.Text, Veri_Yazma_Eeprom_Data_Text.Text, "RW"))
    ...
    Private Sub Veri_Yazma_Adres_Text_TextChanged(sender As Object, e As EventArgs) Handles Veri_Yazma_Adres_Text.TextChanged
        Adres_Text.Text = Veri_Yazma_Adres_Text.Text
    End Sub
    ...
    Private Sub Login_Paramete_Yukle_Buton_Click(sender As Object, e As EventArgs) Handles Login_Paramete_Yukle_Buton.Click
        ...
        If (Yuklenecek_Login_Parametre_Text.Text.Length <> 24) Then
            ...
            Hatavar = True
        ElseIf (Yuklenecek_Pin_Text.Text.Length <> 4) Then
