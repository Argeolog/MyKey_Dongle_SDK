...
namespace MyKey_SDK_CSharp
{
    public partial class Anasayfa : Form
    {
        ...
        {
            string Gelen = Marshal.PtrToStringAnsi(MyKey_DLL.Write_Protected_Data(Veri_Yazma_SessionID_Text.Text, Veri_Yazma_Pin_Text.Text, System.Convert.ToInt32(Veri_Yazma_Adres_Text.Text), Veri_Yazma_Data_Key_Text.Text, Veri_Yazma_Eeprom_Data_Text.Text, "RW"));
        ...
        {
            Okunan_Eeprom_Data_Text.Text = Marshal.PtrToStringAnsi(MyKey_DLL.Read_Protected_Data(Giden_Session_Text.Text, Data_Oku_Pin_Text.Text, System.Convert.ToInt32(Adres_Text.Text), Data_Key_Text.Text));
        }
    }
}
